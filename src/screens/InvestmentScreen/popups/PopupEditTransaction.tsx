...
const PopupEditTransaction = forwardRef<PopupRef, PopupEditTransactionProps>((props, ref) => {
    ...
    const onGetValue = (type: string) => {
        if(!dataForm) return '';
        const { quantity, rate_value, total_value } = dataForm;
        switch (type) {
    ...
    const onSave = async () => {
        ...
        try {
            console.log('loggg dataForm', dataForm)
        ...
        >
            <BottomSheetScrollView contentContainerStyle={styles.contentContainer}>
                ...
                <BottomSheetTextInput
                    ...
                    keyboardType="numeric"
                    placeholder="Nhập giá trị đơn vị"
                />
...
PopupEditTransaction.displayName = 'PopupEditTransaction';
